...
// @route   GET /api/ai-analysis/documents
// @desc    Get franhcise  all documents (admin only)
// @access  Private/Admin
router.get("/documents/:franchiseId", auth, getFranchiseAIDocuments);
...
// @access  Private/Franchise User
router.get(
  "/franchise/download-analysis/:id",
  auth,
  rbac("franchise_user"),
  downloadClaudeAnalysis,
);
